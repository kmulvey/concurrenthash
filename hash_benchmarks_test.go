...
var text = []byte("this is a password")

var benchMatrix = map[string]testPair{
...
func BenchmarkSha512256(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Sha512256"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkSha512224(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Sha512224"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkSha512(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Sha512"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkSha384(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Sha384"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkSha256(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Sha256"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkSha224(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Sha224"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkMurmur64(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Murmur64"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkMurmur32(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Murmur32"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkFnv64a(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Fnv64a"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkFnv64(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Fnv64"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkFnv32a(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Fnv32a"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkFnv32(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Fnv32"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkCrc64ECMA(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Crc64ECMA"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkCrc64ISO(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Crc64ISO"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkCrc32Koopman(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Crc32Koopman"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkCrc32Castagnoli(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Crc32Castagnoli"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkCrc32IEEE(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Crc32IEEE"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
func BenchmarkAdler32(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		hasher.Write(text)
		assert.Equal(b, benchMatrix["Adler32"].BenchExpected, fmt.Sprintf("%x", hasher.Sum(nil)))
	}
}
